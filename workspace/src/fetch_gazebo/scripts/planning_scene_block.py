...
if __name__ == "__main__":
    ...
    p_cube = PoseStamped()
    p_cube.header.frame_id = robot.get_planning_frame()
    p_cube.pose.position.x = trans[0]
    p_cube.pose.position.y = trans[1]
    p_cube.pose.position.z = trans[2]
    scene.add_box("demo_cube", p_cube, (0.06, 0.06, 0.06))
    ################ TO DO ##########################
